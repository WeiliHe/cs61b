...
public class QuickSort {
     ...
     *                  all of the items in unsortedKa that are greater than the given pivot.
     */
    ...
    private static <Item extends Comparable> Queue<Item> rcurCall(Queue<Item> items) {
        if (items.size() == 0) {
        ...
        less = rcurCall(less);
        greater = rcurCall(greater);
        Queue<Item> items1 = catenate(less, equal);
        Queue<Item> items2= catenate(items1, greater);
